                    ...
                    {rewards.map(reward => (
                        <div key={reward.id} className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex justify-between items-center group hover:border-purple-200 transition">
                            <div className="flex items-center gap-4">
                                <div className={`font-bold text-xl px-4 py-2 rounded-lg min-w-[80px] text-center ${reward.pointsCost > 0 ? "bg-purple-100 text-purple-700" : "bg-blue-100 text-blue-700"}`}>
                                    {reward.pointsCost > 0 ? reward.pointsCost : (
                                        <div className="flex flex-col leading-none">
                                            <span className="text-sm">Dinâmico</span>
                                            <span className="text-[10px] opacity-75">20x Preço</span>
                                        </div>
                                    )}
                                </div>
                                <div>
                                    <p className="font-bold text-gray-900 flex items-center gap-2 flex-wrap leading-tight">
                                        ...
                                        {Number(reward.maxDiscountAmount) > 0 && !reward.optionDetails && (
